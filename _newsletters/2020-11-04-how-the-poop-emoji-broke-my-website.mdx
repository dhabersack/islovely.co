...
excerpt: "Turns out font-files can cause bugs, too."
issue: 61
---
import Figure from '../src/components/figure'

I finally put all the fire tips I shared on social media [up on my website](https://islovely.co/firetips) this week. Finding an old tip on Twitter was almost impossible. It’s just not a medium made for later reference. With this move, I can always access them quickly and have full control over how I display them.

Then a friend told me about a bug with these tips.

Firefox Developer Edition on macOS does not show any syntax highlighting on the site. It shows code as dark text on a dark background instead, rendering it unreadable. All other browsers seem to highlight the code as expected.
...
<Figure
  ...
  src="/assets/newsletters/how-the-poop-emoji-broke-my-website/source-code-pro-firefox-de.png"
/>
